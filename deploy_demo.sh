...
ARGUMENTS="(record { \
    ...
    tasks = vec {\
      ...
      record { id = 3; title = \"Fix the water heater\"; description = \"We will have hot water again!\"; state = variant { Open }; voting_power = record { health = 4; spirit = 7 }; claims = vec {}; notes = vec {}; ratings = vec {}; estimated_health = 4; estimated_spirit = 7  }; \
      ...
      record { id = 5; title = \"Closing :(\"; description = \"We all hate it!! claim this task if you're closing this week\"; state = variant { Open }; voting_power = record { health = 2; spirit = 10 }; claims = vec {}; notes = vec {}; ratings = vec {}; estimated_health = 2; estimated_spirit = 10  }; \
      record { id = 6; title = \"Product Sourcing\"; description = \"We gotta stay up to date on these beans\"; state = variant { Open }; voting_power = record { health = 4; spirit = 2 }; claims = vec {}; notes = vec {}; ratings = vec {}; estimated_health = 4; estimated_spirit = 2  }; \
    }; \
    proposals = vec {\
