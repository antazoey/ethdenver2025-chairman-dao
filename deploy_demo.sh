...
ARGUMENTS="(record { \
    ...
    tasks = vec {\
      ...
      record { id = 4; title = \"Singing happy birthday\"; description = \"Anyone who sang happy birthday this week should claim this task\"; state = variant { Open }; voting_power = record { health = 0; spirit = 0 }; claims = vec {}; notes = vec {}; ratings = vec {}; }; \
      record { id = 5; title = \"Game night\"; description = \"This task is for those who contributed to game night\"; state = variant { Open }; voting_power = record { health = 0; spirit = 0 }; claims = vec {}; notes = vec {}; ratings = vec {}; }; \
    }; \
    proposals = vec {\
